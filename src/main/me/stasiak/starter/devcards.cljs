(ns me.stasiak.starter.devcards
  (:require
   [me.stasiak.starter.todo :refer [todo-app]]
...
(defcard bmi-component-2
         "description"
         (devcards/reagent bmi-component-2))

(defcard todo-app
         "description" (devcards/reagent todo-app))
